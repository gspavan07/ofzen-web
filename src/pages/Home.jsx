        ...
        <div className="max-w-[1400px] w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-12 relative mx-auto">
          ...
          >
            ...
            <p className="text-base md:text-xl text-subtext dark:text-gray-600 font-normal leading-relaxed max-w-[540px]">
              From early-stage startups to growing enterprises — we handle
            ...
            <div className="flex items-center gap-6 pt-8 border-t border-black/5 dark:border-white/5">
              <div className="flex flex-col">
                ...
                <span className="text-xs font-medium text-subtext uppercase tracking-tighter">
                  Projects Delivered
                </span>
              </div>
      ...
      <div className="relative z-20 max-w-[960px] mx-auto w-full px-4 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div
            ...
            className="p-8 rounded-3xl border border-black/5 dark:border-white/5 bg-white/20 dark:bg-white/2 backdrop-blur-sm flex flex-col gap-4 group transition-all duration-500"
          >
            <span className="material-symbols-outlined text-primary text-3xl">
              hub
            </span>
            <h3 className="text-lg font-bold text-heading">Strategic Design</h3>
            <p className="text-sm text-subtext dark:text-gray-600 leading-relaxed">
              Interfaces designed around how users actually think — clean, fast,
              and purposeful.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ margin: "-40% 0px -40% 0px" }}
            className="p-8 rounded-3xl border border-black/5 bg-white/20  backdrop-blur-sm flex flex-col gap-4 group transition-all duration-500"
          >
            <span className="material-symbols-outlined text-primary text-3xl">
              memory
            </span>
            ...
            <p className="text-sm text-subtext dark:text-gray-600 leading-relaxed">
              Backend and frontend systems built to handle real load without
              breaking.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ margin: "-40% 0px -40% 0px" }}
            className="p-8 rounded-3xl border border-black/5 dark:border-white/5 bg-white/20 backdrop-blur-sm flex flex-col gap-4 group transition-all duration-500"
          >
            <span className="material-symbols-outlined text-primary text-3xl">
              science
            </span>
            ...
            <p className="text-sm text-subtext dark:text-gray-600 leading-relaxed">
              Exploring what's next — AI tools, automation, and smarter product
              workflows.
            </p>
          </motion.div>
        </div>
