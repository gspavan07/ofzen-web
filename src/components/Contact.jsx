...
const testimonials = [
  {
    ...
    image: sivajiImg,
    quote:
      "Ofzen took our brief and turned it into something we genuinely didn't expect. The process was smooth, the communication was clear, and the final product exceeded what we asked for.",
    verified: true,
  },
  {
    name: "Dr. Rama Sri",
    ...
    image: ramasriImg,
    quote:
      "Professional, responsive, and technically solid. They understood our institutional requirements and delivered a product that our staff and students actually find easy to use.",
    verified: true,
    offset: true,
  },
  {
    ...
    set: true,
    quote:
      "Good team to work with. They kept us informed throughout and delivered on time. The end result has noticeably improved how we present our business online.",
    verified: true,
  },
];
...
const faqs = [
  {
    ...
    answer:
      "We work with a modern tech stack, including React, Next.js, JavaScript, Tailwind CSS, and various cloud and AI services. We choose the right tools for your specific project needs.",
  },
  {
    question: "How do partnership models work?",
    answer:
      "We work on fixed-scope projects, monthly retainers, or long-term embedded partnerships depending on what your team needs. We'll recommend the right model after an initial call.",
  },
  {
    question: "What is the typical project timeline?",
    answer:
      "A standard web or app project runs 6–12 weeks depending on scope. Smaller design or branding work can wrap in 2–4 weeks. We'll give you a clear timeline after the discovery call.",
  },
  {
    question: "How does Ofzen handle data security?",
    answer:
      "We follow standard security practices — encrypted communications, secure credential handling, NDA-protected workflows, and access controls for all client assets.",
  },
];
...
const Contact = () => {
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div
        id="contact"
        className="max-w-[1200px] mx-auto px-4 lg:px-40 py-32 relative"
      >
