    ...
    return (
        <section id="services" className="max-w-[1280px] mx-auto w-full px-6 py-12 md:py-20">
            ...
            <div className="flex flex-col items-center text-center mb-16">
                ...
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight leading-tight max-w-3xl text-heading">
                ...
                >
                    <div className="z-10">
                        ...
                        <p className="text-subtext dark:text-gray-600 text-sm max-w-sm leading-relaxed">
                            Crafting high-performance, accessible, and scalable web experiences that push technical boundaries.
                        </p>
                    </div>
